<script type="text/template" data-grid="main" data-grid-template="view">
		...
		<table id="data-grid" class="table table-hover">
			...
			<thead>
				<tr>
					...
					<th class="sortable" data-grid-sort="private"><i class="fa fa-shield"></i></th>
